            ...
            <form class="form" id="form-register" method="POST" action="php/form_inscription.php">
                ...
                <section>
                    <div class="form-group">
                        <input type="text" class="form-control" id="firstname" name="firstname" aria-describedby="firstname" placeholder="prénom">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" id="lastname" name="lastname" aria-describedby="lastname" placeholder="nom">
                    </div>
                    <div class="form-group">
                        <input id="mail" type="email" name="mail" class="form-control" class="col-xs-4" aria-describedby="mail" placeholder="email@laplateforme.io">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="password" class="form-control" name="check_password" id="check_password" placeholder="confirmer mot de passe">
                    </div>
